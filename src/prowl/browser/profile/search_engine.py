...
Usage::
    ...
    from prowl.browser.profile.search_engine import SearchEngineInjector
...
class SearchEngineInjector:
    ...
    def __init__(self, profile_dir: str | Path) -> None:
        ...
        if not self._db_path.exists():
            msg = f"Web Data not found at {self._db_path}. Launch Chrome in this profile at least once to generate it."
    ...
    def _update_preferences(  # noqa: PLR0913, PLR0917
        self,
        row_id: int,
        keyword: str,
        url: str,
